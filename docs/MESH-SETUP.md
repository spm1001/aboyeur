> **HISTORICAL — the mesh was deleted on 2026-08-24 (son-pilalu / aby-nedora).**
> Nothing below is runnable: sonnette is delisted from the batterie marketplace,
> uninstalled estate-wide, and its code is gone from this repo (`4f41e80`).
> This file is kept deliberately, at `aby-dunudo`'s request, because the
> delivery-semantics measurements in it explain *why* the honesty bar for the
> successor was set where it was. Read it as evidence, not as instructions.
> Where each capability went: `docs/mesh-retirement-2026-08-24.md`.
